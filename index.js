...
let orijinalTatlar3 = kopyala(orijinalTatlar2);
...
function indekstekiCesitiGetir(liste, cikarilacak) {
  for (let i = 0; i < liste.length; i++) {
    if (liste[i] == cikarilacak) {
      liste.splice(i, 1);
    }
  }
}
console.log(indekstekiCesitiGetir(orijinalTatlar, "Tarçın"));
